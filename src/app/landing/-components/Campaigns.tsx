				...
				<AnimatePresence mode="wait">
                    ...
                    >
                        <div className="absolute bottom-0 left-0 text-white sm:p-12 p-2 w-full">
                            <h3 className="sm:text-[2.625rem] sm:leading-[60px] text-subtitle-2 font-bold text-ellipsis line-clamp-1">{selectedCampaign.title}</h3>
                            <p className="sm:text-[1.75rem] sm:leading-[36px]  text-paragraph-3 text-ellipsis line-clamp-3">{selectedCampaign.description}</p>
                        </div>
                    </motion.div>
                </AnimatePresence>
