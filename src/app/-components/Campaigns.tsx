...
export function CampaignSection() {
	...
	return (
		<div id="campaigns" ref={sectionRef}>
					...
					>
						...
						{!isPlaying && (
							<div className="absolute bottom-0 left-0 text-white sm:p-12 p-2 w-full">
								<h3 className="sm:text-h3 text-subtitle-2 font-bold text-ellipsis line-clamp-1">
									{selectedCampaign.title}
								</h3>
								<p className="sm:text-subtitle text-paragraph-3 text-ellipsis line-clamp-3">
