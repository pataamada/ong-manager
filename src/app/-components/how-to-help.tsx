...
const helpItems = [
	{
		...
		description:
			"Transforme a vida de um peludo e encontre um amigo fiel para sempre com você!",
	},
	{
...
export function HowToHelp() {
	return (
		<div id="how-to-help" className="py-8 w-full">
